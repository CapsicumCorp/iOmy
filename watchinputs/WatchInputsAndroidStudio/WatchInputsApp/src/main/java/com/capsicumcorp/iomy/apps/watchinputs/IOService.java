...
public class IOService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (!Application.getInstance().getServiceStarted()) {
            Log.println(Log.INFO, Application.getInstance().getAppName(), "Monitoring Service: Entering onStartCommand");
    ...
    public void onDestroy() {
        Log.println(Log.INFO, Application.getInstance().getAppName(), "Entering IOService.destroy");
        Application.getInstance().onServiceDestroy();
        stopForeground(true);
        Log.println(Log.INFO, Application.getInstance().getAppName(), "Exiting IOService.destroy");
    }
    ...
    public static Intent createIntent(Context context) {
            return new Intent(context, IOService.class);
    }
}
