...
PACKAGES="ZLIB BZIP2 OPENSSL CURL ICONV NCURSES MHASH LIBMCRYPT PCRE LIBPNG LIBJPEG READLINE LIBXML2 FREETYPE LIBAIO SDL FFMPEG LIGHTTPD PHP MYSQL PHPMYADMIN"
