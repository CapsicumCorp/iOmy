...
baseassetsdir="${basedir}/../CapsicumWebServer/CapsicumWebServerApp/src/main/assetssrc"
destassetsdir="${basedir}/../CapsicumWebServer/CapsicumWebServerApp/src/main/assets/"
...
zip -9r "${destassetsdir}/webserverassets.zip" components scripts tmp var htdocs
if [ $? != 0 ] ; then
  exit 1
fi
