...
class VR_USERSROOMS{
	public $USERS_PK;
	public $PERMROOMS_READ;
	public $PERMROOMS_WRITE;
	public $PERMROOMS_STATETOGGLE;
	public $PERMROOMS_DATAREAD;
...
class CreateMainMetadata
{
	...
	public static function create() {
		...
		$metadata->addPrimitiveProperty(    $VR_USERSINFOEntityType,        'REGION_NAME2',             EdmPrimitiveType::CHARARRAY     );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISESEntityType,    'PERMPREMISE_OWNER',        EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISESEntityType,    'PERMPREMISE_WRITE',        EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISESEntityType,    'PERMPREMISE_STATETOGGLE',  EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISESEntityType,    'PERMPREMISE_READ',         EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISESEntityType,    'PERMPREMISE_ROOMADMIN',    EdmPrimitiveType::INT16         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISELOCATIONSEntityType,    'PERMPREMISE_ROOMADMIN',    EdmPrimitiveType::INT16);
		...
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISELOCATIONSEntityType,    'REGION_NAME2',             EdmPrimitiveType::CHARARRAY);
		...
		$metadata->addPrimitiveProperty(    $VR_USERSHUBEntityType,    'PERMPREMISE_READ',        EdmPrimitiveType::INT16       );
		...
		$metadata->addPrimitiveProperty(        $VR_USERSROOMSEntityType,    'PERMROOMS_READ',              EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(        $VR_USERSROOMSEntityType,    'PERMROOMS_WRITE',             EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(        $VR_USERSROOMSEntityType,    'PERMROOMS_STATETOGGLE',       EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(        $VR_USERSROOMSEntityType,    'PERMROOMS_DATAREAD',          EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(              $VR_USERSROOMSEntityType,    'ROOMS_PK',                    EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(        $VR_USERSROOMSEntityType,    'ROOMS_PREMISE_FK',            EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'PERMROOMS_READ',           EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'PERMROOMS_WRITE',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'PERMROOMS_STATETOGGLE',    EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'PERMROOMS_DATAREAD',       EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'ROOMS_PK',                 EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'ROOMS_PREMISE_FK',         EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'ROOMS_NAME',               EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'ROOMS_FLOOR',              EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'ROOMS_DESC',               EdmPrimitiveType::CHARARRAY     );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSLINKEntityType,            'LINK_COMM_FK',             EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'PERMROOMS_READ',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'PERMROOMS_WRITE',         EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'PERMROOMS_STATETOGGLE',   EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'PERMROOMS_DATAREAD',      EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'ROOMS_PK',                EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'ROOMS_PREMISE_FK',        EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSTHINGEntityType,        'LINK_COMM_FK',            EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'PERMROOMS_READ',             EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'PERMROOMS_WRITE',            EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'PERMROOMS_STATETOGGLE',      EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'PERMROOMS_DATAREAD',         EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'ROOMS_PK',                   EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'ROOMS_PREMISE_FK',           EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'LINK_PK',                    EdmPrimitiveType::INT64         );
		$metadata->addPrimitiveProperty(    $VR_USERSIOEntityType,        'LINK_COMM_FK',               EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'PERMROOMS_READ',             EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'PERMROOMS_WRITE',            EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'PERMROOMS_STATETOGGLE',      EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'PERMROOMS_DATAREAD',         EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATATINYINTEntityType,        'ROOMS_PK',                   EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'ROOMS_NAME',                 EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'ROOMS_FLOOR',                EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYINTEntityType,        'ROOMS_PREMISE_FK',           EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'PERMROOMS_READ',             EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'PERMROOMS_WRITE',            EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'PERMROOMS_STATETOGGLE',      EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'PERMROOMS_DATAREAD',         EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATAINTEntityType,            'ROOMS_PK',                   EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'ROOMS_NAME',                 EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'ROOMS_FLOOR',                EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATAINTEntityType,            'ROOMS_PREMISE_FK',           EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'PERMROOMS_READ',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'PERMROOMS_WRITE',         EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'PERMROOMS_STATETOGGLE',   EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'PERMROOMS_DATAREAD',      EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATABIGINTEntityType,        'ROOMS_PK',                EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'ROOMS_NAME',              EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'ROOMS_FLOOR',             EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATABIGINTEntityType,        'ROOMS_PREMISE_FK',        EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'PERMROOMS_READ',           EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'PERMROOMS_WRITE',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'PERMROOMS_STATETOGGLE',    EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'PERMROOMS_DATAREAD',       EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATAFLOATEntityType,        'ROOMS_PK',                 EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'ROOMS_NAME',               EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'ROOMS_FLOOR',              EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATAFLOATEntityType,        'ROOMS_PREMISE_FK',         EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'PERMROOMS_READ',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'PERMROOMS_WRITE',         EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'PERMROOMS_STATETOGGLE',   EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'PERMROOMS_DATAREAD',      EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATATINYSTRINGEntityType,    'ROOMS_PK',                EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'ROOMS_NAME',              EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'ROOMS_FLOOR',             EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATATINYSTRINGEntityType,    'ROOMS_PREMISE_FK',        EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'PERMROOMS_READ',           EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'PERMROOMS_WRITE',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'PERMROOMS_STATETOGGLE',    EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'PERMROOMS_DATAREAD',       EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATASHORTSTRINGEntityType,      'ROOMS_PK',                 EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'ROOMS_NAME',               EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'ROOMS_FLOOR',              EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATASHORTSTRINGEntityType,      'ROOMS_PREMISE_FK',         EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'PERMROOMS_READ',           EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'PERMROOMS_WRITE',          EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'PERMROOMS_DATAREAD',       EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'PERMROOMS_STATETOGGLE',    EdmPrimitiveType::INT16         );
		$metadata->addKeyProperty(          $VR_DATAMEDSTRINGEntityType,    'ROOMS_PK',                 EdmPrimitiveType::INT64         );	
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'ROOMS_NAME',               EdmPrimitiveType::CHARARRAY     );
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'ROOMS_FLOOR',              EdmPrimitiveType::INT32         );
		$metadata->addPrimitiveProperty(    $VR_DATAMEDSTRINGEntityType,    'ROOMS_PREMISE_FK',         EdmPrimitiveType::INT64         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSPREMISELOGEntityType, 'PERMPREMISE_READ',          EdmPrimitiveType::INT16         );
		...
		$metadata->addPrimitiveProperty(    $VR_USERSCOMMEntityType,    'PERMPREMISE_OWNER',        EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSCOMMEntityType,    'PERMPREMISE_WRITE',        EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSCOMMEntityType,    'PERMPREMISE_STATETOGGLE',  EdmPrimitiveType::INT16         );
		$metadata->addPrimitiveProperty(    $VR_USERSCOMMEntityType,    'PERMPREMISE_READ',         EdmPrimitiveType::INT16         );
		...
		$metadata->addPrimitiveProperty(    $VP_REGIONEntityType,       'REGION_NAME2',          EdmPrimitiveType::CHARARRAY     );
		...
		$metadata->addPrimitiveProperty(    $VP_CURRENCIESEntityType,       'REGION_NAME2',             EdmPrimitiveType::CHARARRAY     );
