...
*/
	...
	class MainQueryProvider implements IDataServiceQueryProvider2 {
		...
		private function _serializeVR_USERSTHING($record) {
			...
			$VR_USERSTHING->ROOMS_NAME					= $record['ROOMS_NAME'];
			$VR_USERSTHING->ROOMS_FLOOR					= $record['ROOMS_FLOOR'];
		...
		private function _serializeVR_USERSIO($record) {
			...
			$VR_USERSIO->ROOMS_NAME						= $record['ROOMS_NAME'];
			$VR_USERSIO->ROOMS_FLOOR					= $record['ROOMS_FLOOR'];
		...
		private function _serializeVR_DATATINYINT($record) {
			...
			$VR_DATATINYINT->ROOMS_PK             			= $record['ROOMS_PK'];
			$VR_DATATINYINT->ROOMS_NAME             		= $record['ROOMS_NAME'];
			$VR_DATATINYINT->ROOMS_FLOOR             		= $record['ROOMS_FLOOR'];
			$VR_DATATINYINT->ROOMS_PREMISE_FK            	= $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATAINT($record) {
			...
			$VR_DATAINT->ROOMS_PK             				= $record['ROOMS_PK'];
			$VR_DATAINT->ROOMS_NAME             			= $record['ROOMS_NAME'];
			$VR_DATAINT->ROOMS_FLOOR             			= $record['ROOMS_FLOOR'];
			$VR_DATAINT->ROOMS_PREMISE_FK           	 	= $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATABIGINT($record) {
			...
			$VR_DATABIGINT->ROOMS_PK             			= $record['ROOMS_PK'];
			$VR_DATABIGINT->ROOMS_NAME             			= $record['ROOMS_NAME'];
			$VR_DATABIGINT->ROOMS_FLOOR             		= $record['ROOMS_FLOOR'];
			$VR_DATABIGINT->ROOMS_PREMISE_FK           	 	= $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATAFLOAT($record) {
			...
			$VR_DATAFLOAT->ROOMS_PK             			= $record['ROOMS_PK'];
			$VR_DATAFLOAT->ROOMS_NAME             			= $record['ROOMS_NAME'];
			$VR_DATAFLOAT->ROOMS_FLOOR             			= $record['ROOMS_FLOOR'];
			$VR_DATAFLOAT->ROOMS_PREMISE_FK           	 	= $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATATINYSTRING($record)
		{
			...
			$VR_DATATINYSTRING->ROOMS_PK             		= $record['ROOMS_PK'];
			$VR_DATATINYSTRING->ROOMS_NAME             		= $record['ROOMS_NAME'];
			$VR_DATATINYSTRING->ROOMS_FLOOR             	= $record['ROOMS_FLOOR'];
			$VR_DATATINYSTRING->ROOMS_PREMISE_FK           	 = $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATASHORTSTRING($record) {
			...
			$VR_DATASHORTSTRING->ROOMS_PK             		= $record['ROOMS_PK'];
			$VR_DATASHORTSTRING->ROOMS_NAME             	= $record['ROOMS_NAME'];
			$VR_DATASHORTSTRING->ROOMS_FLOOR             	= $record['ROOMS_FLOOR'];
			$VR_DATASHORTSTRING->ROOMS_PREMISE_FK           = $record['ROOMS_PREMISE_FK'];
		...
		private function _serializeVR_DATAMEDSTRING($record) {
			...
			$VR_DATAMEDSTRING->ROOMS_PK             	= $record['ROOMS_PK'];
			$VR_DATAMEDSTRING->ROOMS_NAME             	= $record['ROOMS_NAME'];
			$VR_DATAMEDSTRING->ROOMS_FLOOR             	= $record['ROOMS_FLOOR'];
			$VR_DATAMEDSTRING->ROOMS_PREMISE_FK         = $record['ROOMS_PREMISE_FK'];
