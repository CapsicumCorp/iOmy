...
$.extend(IomyRe.devices.weatherfeed,{
    ...
    FetchAddLinkAPIAndParameters : function (oScope) {
        ...
        mData.url = IomyRe.apiphp.APILocation("weather");
		mData.data = {
    ...
    FetchCurrentWeather : function (iThingId, oScope, sPrefix) {
        ...
        IomyRe.apiphp.AjaxRequest({
                ...
                if (data.Error === false) {
                    ...
                    if (oScope.byId(sPrefix + me.uiIDs.sSunriseDisplayID) !== undefined) {
                        try {
                            ...
                            oScope.byId(sPrefix + me.uiIDs.sSunriseDisplayID).setText( IomyRe.functions.getTimestampString(dateSunrise, "") );
                        } catch (e) {
                            jQuery.sap.log.error(e.message);
                    ...
                    if (oScope.byId(sPrefix + me.uiIDs.sSunsetDisplayID) !== undefined) {
                        try {
                            ...
                            oScope.byId(sPrefix + me.uiIDs.sSunsetDisplayID).setText( IomyRe.functions.getTimestampString(dateSunset, "") );
                        } catch (e) {
                            jQuery.sap.log.error(e.message);
            ...
            setFailureNotices : function (errMessage) {
                //IomyRe.common.showError("Failed to load the weather information:\n\n"+errMessage, "Error");
                ...
                items : [
                    new sap.m.Link( oViewScope.createId( sPrefix+"_Label"), {
                        ...
                        press : function () {
                            ...
                            IomyRe.common.NavigationChangePage("pThermostat", {ThingId : aDeviceData.DeviceId});
                        }
