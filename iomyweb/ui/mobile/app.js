...
var aPages = [
    ...
    {
		"Id":			"pNavMain",
		"Location":		"mjs.navigation.Main",
		"Type":			"JS",
		"ErrMesg":		"Critical Error: Couldn't load \"mjs.navigation.Main (Navigation)\" Page!\n"
	},
    // --- Premise Overview --- \\
    {
		"Id":			"pPremiseOverview",
	...
	},
    {
		...
		"Type":			"JS",
		"ErrMesg":		"Critical Error: Couldn't load \"mjs.settings.EditUserInformation\" Page!\n"
	},
    {
...
/*//-- LOGIN PAGE --//
try {
	var oLoginPage = sap.ui.view({id:"pLogin", viewName:"mjs.login.Login", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oLoginPage);
} catch(ePLogin) {
	console.log("Critical Error: Couldn't load \"mjs.login.Login\" Page!\n"+ePLogin.message);
}

//-- NAVIGATION PAGE --//
try {
	var oNavPage = sap.ui.view({id:"pNavMain", viewName:"mjs.navigation.Main", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oNavPage);
} catch(ePNavigation) {
	console.log("Critical Error: Couldn't load \"mjs.navigation.Main (Navigation)\" Page!\n"+ePNavigation.message);
}

//-- PREMISE OVERVIEW PAGE --//
try {	
	var oPremiseOverviewPage = sap.ui.view({id:"pPremiseOverview", viewName:"mjs.premise.PremiseOverview", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oPremiseOverviewPage);
} catch(ePPremiseOverview) {
	console.log("Critical Error: Couldn't load \"mjs.premise.PremiseOverview\" Page!\n"+ePPremiseOverview.message);
}

//-- ROOM OVERVIEW PAGE --//
try {	
	var oRoomOverviewPage = sap.ui.view({id:"pRoomsOverview", viewName:"mjs.rooms.Room", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oRoomOverviewPage);
} catch(ePRoomOverview) {
	console.log("Critical Error: Couldn't load \"mjs.rooms.Room\" Page!\n"+ePRoomOverview.message);
}

//-- ROOM OVERVIEW PAGE --//
try {	
	var oRoomUnassignedDevicesPage = sap.ui.view({id:"pRoomsUnassignedDevices", viewName:"mjs.rooms.UnassignedDevices", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oRoomUnassignedDevicesPage);
} catch(ePRoomUnassignedDevices) {
	console.log("Critical Error: Couldn't load \"mjs.rooms.UnassignedDevices\" Page!\n"+ePRoomUnassignedDevices.message);
}

//-- SETTINGS PAGE --//
try {
	var oSettingsPage = sap.ui.view({id:"pSettingsOverview", viewName:"mjs.settings.SettingsOverview", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oSettingsPage);
} catch(ePSettingsOverview) {
	console.log("Critical Error: Couldn't load \"mjs.settings.SettingsOverview\" Page!\n"+ePSettingsOverview.message);
}

//-- SETTINGS DEVICE LIST PAGE --//
try {
	var oDeviceListPage = sap.ui.view({id:"pSettingsDeviceList", viewName:"mjs.settings.DeviceList", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oDeviceListPage);
} catch(ePDeviceListOverview) {
	console.log("Critical Error: Couldn't load \"mjs.settings.DeviceList\" Page!\n"+ePDeviceListOverview.message);
}

//-- SETTINGS DEVICE INFO PAGE --//
try {
	var oDeviceInfoPage = sap.ui.view({id:"pSettingsDeviceInfo", viewName:"mjs.settings.DeviceInfo", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oDeviceInfoPage);
} catch(ePDeviceInfoOverview) {
	console.log("Critical Error: Couldn't load \"mjs.settings.DeviceInfo\" Page!\n"+ePDeviceInfoOverview.message);
}

//-- SETTINGS ADD DEVICE PAGE --//
try {
	var oDeviceAddPage = sap.ui.view({id:"pSettingsDeviceAddManually", viewName:"mjs.settings.devices.DeviceAddManually", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oDeviceAddPage);
} catch(ePDeviceAdd) {
	console.log("Critical Error: Couldn't load \"mjs.settings.devices.DeviceAddManually\" Page!\n"+ePDeviceAdd.message);
}

//-- SETTINGS ADD DEVICE SCAN PAGE --//
try {
	var oDeviceAddScanPage = sap.ui.view({id:"pSettingsDeviceAdd", viewName:"mjs.settings.devices.DeviceAddScan", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oDeviceAddScanPage);
} catch(ePDeviceAddScan) {
	console.log("Critical Error: Couldn't load \"mjs.settings.devices.DeviceAddScan\" Page!\n"+ePDeviceAddScan.message);
}

//-- SETTINGS EDIT USER PAGE --//
try {
	var oEditUserPage = sap.ui.view({id:"pSettingsUser", viewName:"mjs.settings.EditUser", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditUserPage);
} catch(ePEditUser) {
	console.log("Critical Error: Couldn't load \"mjs.settings.EditUser\" Page!\n"+ePEditUser.message);
}

//-- SETTINGS EDIT USER INFO PAGE --//
try {
	var oEditUserInfoPage = sap.ui.view({id:"pSettingsUserInfo", viewName:"mjs.settings.user.EditUserInformation", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditUserInfoPage);
} catch(ePEditUserInfo) {
	console.log("Critical Error: Couldn't load \"mjs.settings.user.EditUserInformation\" Page!\n"+ePEditUserInfo.message);
}

//-- SETTINGS EDIT USER PASSWORD PAGE --//
try {
	var oEditUserPasswordPage = sap.ui.view({id:"pSettingsUserPassword", viewName:"mjs.settings.user.UserEditPassword", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditUserPasswordPage);
} catch(ePEditUserPassword) {
	console.log("Critical Error: Couldn't load \"mjs.settings.user.EditUserPassword\" Page!\n"+ePEditUserPassword.message);
}

//-- SETTINGS EDIT USER ADDRESS PAGE --//
try {
	var oEditUserAddressPage = sap.ui.view({id:"pSettingsUserAddress", viewName:"mjs.settings.user.EditUserAddress", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditUserAddressPage);
} catch(ePEditUserAddress) {
	console.log("Critical Error: Couldn't load \"mjs.settings.user.EditUserAddress\" Page!\n"+ePEditUserAddress.message);
}

//-- SETTINGS PREMISE LIST PAGE --//
try {
	var oPremiseListPage = sap.ui.view({id:"pSettingsPremiseList", viewName:"mjs.settings.PremiseList", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oPremiseListPage);
} catch(ePPremiseList) {
	console.log("Critical Error: Couldn't load \"mjs.settings.PremiseList\" Page!\n"+ePPremiseList.message);
}

//-- SETTINGS PREMISE VIEW PAGE --//
try {
	var oPremiseInfoPage = sap.ui.view({id:"pSettingsPremise", viewName:"mjs.settings.Premise", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oPremiseInfoPage);
} catch(ePPremiseInfo) {
	console.log("Critical Error: Couldn't load \"mjs.settings.Premise\" Page!\n"+ePPremiseInfo.message);
}

//-- SETTINGS EDIT PREMISE INFO PAGE --//
try {
	var oEditPremisePage = sap.ui.view({id:"pSettingsPremiseInfo", viewName:"mjs.settings.premise.PremiseEditInfo", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditPremisePage);
} catch(ePEditPremise) {
	console.log("Critical Error: Couldn't load \"mjs.settings.premise.PremiseEditInfo\" Page!\n"+ePEditPremise.message);
}

//-- SETTINGS EDIT HUB PAGE --//
try {
	var oEditHubPage = sap.ui.view({id:"pSettingsPremiseGateway", viewName:"mjs.settings.premise.PremiseEditHub", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditHubPage);
} catch(ePEditHub) {
	console.log("Critical Error: Couldn't load \"mjs.settings.premise.PremiseEditHub\" Page!\n"+ePEditHub.message);
}

//-- SETTINGS EDIT PREMISE ADDRESS PAGE --//
try {
	var oEditPremiseAddressPage = sap.ui.view({id:"pSettingsPremiseAddress", viewName:"mjs.settings.premise.PremiseEditAddress", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditPremiseAddressPage);
} catch(ePEditPremiseAddress) {
	console.log("Critical Error: Couldn't load \"mjs.settings.premise.EditPremiseAddress\" Page!\n"+ePEditPremiseAddress.message);
}

//-- SETTINGS EDIT ROOM PAGE --//
try {
	var oEditRoomPage = sap.ui.view({id:"pSettingsRoomEdit", viewName:"mjs.settings.rooms.RoomEdit", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oEditRoomPage);
} catch(ePEditRoom) {
	console.log("Critical Error: Couldn't load \"mjs.settings.rooms.RoomEdit\" Page!\n"+ePEditRoom.message);
}

//-- SETTINGS ADD ROOM PAGE --//
try {
	var oAddRoomPage = sap.ui.view({id:"pSettingsRoomAdd", viewName:"mjs.settings.rooms.RoomAdd", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oAddRoomPage);
} catch(ePAddRoom) {
	console.log("Critical Error: Couldn't load \"mjs.settings.rooms.RoomAdd\" Page!\n"+ePAddRoom.message);
}

//-- SETTINGS ROOM DEVICE PAGE --//
try {
	var oDeviceRoomPage = sap.ui.view({id:"pSettingsRoomDevice", viewName:"mjs.settings.rooms.RoomDevice", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oDeviceRoomPage);
} catch(ePDeviceRoom) {
	console.log("Critical Error: Couldn't load \"mjs.settings.rooms.RoomDevice\" Page!\n"+ePDeviceRoom.message);
}

//-- HEALTH PAGE --//
try {
	var oHealthPage = sap.ui.view({id:"pHealth", viewName:"mjs.health.Health", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oHealthPage);
} catch(ePHealth) {
	console.log("Critical Error: Couldn't load \"mjs.health.Health\" Page!\n"+ePHealth.message);
}

//-- SECURITY PAGE --//
try {
	var oHealthPage = sap.ui.view({id:"pSecurity", viewName:"mjs.security.Security", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oHealthPage);
} catch(ePHealth) {
	console.log("Critical Error: Couldn't load \"mjs.security.Security\" Page!\n"+ePHealth.message);
}

//-- SECURITY IP CAMERA PAGE --//
try {
	var oHealthPage = sap.ui.view({id:"pSecurityIPCamera", viewName:"mjs.security.SecurityIPCamera", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oHealthPage);
} catch(ePHealth) {
	console.log("Critical Error: Couldn't load \"mjs.security.SecurityIPCamera\" Page!\n"+ePHealth.message);
}

//-- ACTIVITY PAGE --//
try {
	var oActivityPage = sap.ui.view({id:"pActivity", viewName:"mjs.activity.ActivityLog", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oActivityPage);
} catch(ePActivity) {
	console.log("Critical Error: Couldn't load \"mjs.activity.ActivityLog\" Page!\n"+ePActivity.message);
}

//-- ACTIVITY DEVICE PAGE --//
try {
	var oActivityDevicePage = sap.ui.view({id:"pActivityDeviceLog", viewName:"mjs.activity.ActivityDeviceLog", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oActivityDevicePage);
} catch(ePActivityDevice) {
	console.log("Critical Error: Couldn't load \"mjs.activity.ActivityDeviceLog\" Page!\n"+ePActivityDevice.message);
}

//-- ACTIVITY USER PAGE --//
try {
	var oActivityUserPage = sap.ui.view({id:"pActivityUserLog", viewName:"mjs.activity.ActivityUserLog", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oActivityUserPage);
} catch(ePActivityUser) {
	console.log("Critical Error: Couldn't load \"mjs.activity.ActivityUserLog\" Page!\n"+ePActivityUser.message);
}

//-- ACTIVITY PREMISE PAGE --//
try {
	var oActivityPremisePage = sap.ui.view({id:"pActivityPremiseLog", viewName:"mjs.activity.ActivityPremiseLog", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oActivityPremisePage);
} catch(ePActivityPremise) {
	console.log("Critical Error: Couldn't load \"mjs.activity.ActivityPremiseLog\" Page!\n"+ePActivityPremise.message);
}

//-- FORCE SWITCH --//
try {
	var oForceSwitchUser = sap.ui.view({id:"pForceSwitchUser", viewName:"mjs.login.ForceSwitchUser", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oForceSwitchUser);
} catch(ePForceSwitchUser) {
	console.log("Critical Error: Couldn't load \"mjs.login.ForceSwitchUser\" Page!\n"+ePForceSwitchUser.message);
}

//-- DEBUGGING --//
try {
	var oAndrewDebug = sap.ui.view({id:"pAndrewDebugging", viewName:"mjs.premise.DeviceData", type:sap.ui.core.mvc.ViewType.JS});
	oApp.addPage(oAndrewDebug);
} catch(ePAndrewDebug) {
	console.log("Critical Error: Couldn't load \"mjs.premise.DeviceData\" Page!\n"+ePAndrewDebug.message);
}*/
