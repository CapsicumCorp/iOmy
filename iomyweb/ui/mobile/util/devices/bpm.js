...
Description: Provides the UI and functionality for a Blood Pressure Monitor
    entry.
...
$.sap.declare("IOMy.devices.bpm",true);
IOMy.devices.bpm = new sap.ui.base.Object();

$.extend(IOMy.devices.bpm,{
	Devices: [],
