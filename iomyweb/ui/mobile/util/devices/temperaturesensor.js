...
Description: Provides the UI for a Temperature Sensor entry.
...
$.sap.declare("IOMy.devices.temperaturesensor",true);
IOMy.devices.temperaturesensor = new sap.ui.base.Object();

$.extend(IOMy.devices.temperaturesensor,{
	Devices: [],
	...
	GetCommonUI: function( sPrefix, oViewScope, aDeviceData, bIsUnassigned ) {
        ...
        // If the UI is for the Unassigned Devices List, include a checkbox
