/*
Title: Get Number of Premises
Author: Brent Jarmaine (Capsicum Corporation) <brenton@capsicumcorp.com>
Description: Retrieves the number of premises that are visible to the current
    user.
...
$.sap.declare("IOMy.functions.getNumberOfPremises",true);
