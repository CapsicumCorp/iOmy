/*
Title: Get Number of Things attached to a Link
Author: Brent Jarmaine (Capsicum Corporation) <brenton@capsicumcorp.com>
Description: Retrieve the number of objects attached to a link the current user
    has access to.
...
$.sap.declare("IOMy.functions.getNumberOfThingsInLink",true);
