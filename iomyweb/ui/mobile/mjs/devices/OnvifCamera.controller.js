...
sap.ui.controller("mjs.devices.OnvifCamera", {
    ...
    loadProfile : function() {
        ...
        console.log(me.oThing.IOs);
        
        // Prepare the filter statements for both OData requests
        $.each(me.oThing.IOs, function(sI,mIO) {
                ...
                try {
                    ...
                    thisView.byId("extrasMenuHolder").addItem(
                        IOMy.widgets.getExtrasButton({
                            id : me.createId("extrasMenu"+me.oThing.DeviceId+me.oThing.DeviceName.replace(/[ '"?><=\\\-!@#$%\^&*()]/g, "")),        // Uses the page ID
