...
sap.ui.jsview("mjs.staging.WindowSensor", {
	...
	****************************************************************************************************/ 
	getControllerName : function() {
		return "mjs.staging.WindowSensor";
	},
	...
	****************************************************************************************************/ 
	createContent : function(oController) {
		...
		var oPage = new sap.m.Page(me.createId("page"),{
			...
			content : [
                //-- Navigational Header --//
				IOMy.widgets.getNavigationalSubHeader("Widnows Sensor", "sap-icon://GoogleMaterial/border_all", me),
