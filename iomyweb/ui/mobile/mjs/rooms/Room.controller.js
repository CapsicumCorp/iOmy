...
sap.ui.controller("mjs.rooms.Room", {
    ...
    ************************************************************************************************************************/
    ...
    roomID:                            null,
    iDevices    : 0,        //-- INTEGER:   The number of devices associated with the currently selected room. If 0, then the user will be taken back to the previous page.               --//
            ...
            onBeforeShow : function (evt) {
                ...
                if( me.dLastAjaxUpdate!==null && me.dLastDeviceUpdate !== null) {
                    ...
                    if( me.iLastRoomId===evt.data.room.RoomId ) {
                        if (IOMy.common.ThingListLastUpdate !== me.dLastDeviceUpdate) {
...
*/
    ...
    ************************************************************************************************************************/
    ...
    InitialThingUISetup: function() {
        ...
        oController.dLastDeviceUpdate = IOMy.common.ThingListLastUpdate;
