...
public class DBSetupProgressPage extends ProgressPage {
    ...
    private void startSettingUpDatabase() {
        ...
        testConnection.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createNewSchema.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables1.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables2.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables3.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables4.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables5.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createTables6.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic1.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic2.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic3.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic4.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic5.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewPublic6.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted1.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted2.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted3.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted4.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted5.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createViewRestricted6.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createDefaultData1.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createDefaultData2.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createDefaultData3.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createDefaultData4.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys1.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys2.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys3.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys4.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys5.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys6.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys7.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys8.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys9.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys10.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys11.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys12.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys13.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys14.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys15.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys16.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys17.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys18.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys19.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        createForeignKeys20.setRetryPolicy(new DefaultRetryPolicy(defaultTimeout, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
